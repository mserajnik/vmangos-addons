...
BeneCast_Localization.enUS = {
	...
	TEXT_PARTY_CHANNEL_TOOLTIP = 'Send spell notification through party chat.',
	TEXT_RAID_CHANNEL_TOOLTIP = 'Send spell notification through raid chat.',
	TEXT_WHISPER_TARGET_TOOLTIP = 'Send spell notification through a whisper to the spells target.',
	TEXT_EMOTE_CHANNEL_TOOLTIP = 'Send spell notifications through an emote to those around you.',
	TEXT_SAY_CHANNEL_TOOLTIP = 'Send spell notification through say',
	TEXT_NOTIFY_USER_CHANNEL_TOOLTIP = 'Send spell notification through a user defined channel. You must have joined the channel in order to send notification to the channel.',
